    ...
    >
      ...
      <Collapsible title="File-based routing">
        <ThemedText>
          ...
          <ThemedText>src/app/(tabs)/index.tsx</ThemedText> and{" "}
          <ThemedText>src/app/(tabs)/explore.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
          The layout file in <ThemedText>src/app/(tabs)/_layout.tsx</ThemedText>{" "}
      ...
      <Collapsible title="Light and dark mode components">
        <ThemedText>
          ...
          the user&apos;s current color scheme is, and so you can adjust UI
          colors accordingly.
        </ThemedText>
      ...
      <Collapsible title="Animations">
        <ThemedText>
          ...
          powerful{" "}
          <ThemedText style={{ fontFamily: Fonts.mono }}>
